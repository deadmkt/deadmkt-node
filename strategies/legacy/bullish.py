...
"""
strategies/bullish.py
Bullish strategy — higher midpoint than default.
Crosses with bearish strategy's sell orders.

  buy  at 0.051 * 0.998 = 0.050898
  sell at 0.051 * 1.002 = 0.051102
...
DEFAULT_PRICE = Decimal("0.051")         # Bullish: above 0.05 midpoint
