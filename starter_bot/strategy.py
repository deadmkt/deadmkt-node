...
"""
starter_bot/strategy.py — Default trading strategy shipped with every node.
...
Handles its own token management: auto-mints when escrow runs low,
claims pending mints, and rebalances across the token triangle.
...
PAIR_BASE_PRICES = {
    "EMM/KAY": Decimal("1.0"),     # 1 EMM costs 1.0 KAY
    "KAY/TEE": Decimal("1.0"),     # 1 KAY costs 1.0 TEE
    "TEE/EMM": Decimal("1.0"),     # 1 TEE costs 1.0 EMM
}
